...
--- @field buffer_lifetime 'wipe'|'hide'? Determines how the buffer is handled when the window is closed. 'wipe' will wipe the buffer, while 'hide' will hide it. Default is 'wipe'.
